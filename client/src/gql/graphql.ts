...
export type EventsQuery = { __typename?: 'Query', events: Array<{ __typename?: 'Event', name: string, phase: string, pos: number, id: string, indexInBlock: number, block: { __typename?: 'Block', height: number, timestamp: any } }> };
