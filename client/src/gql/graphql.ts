...
export type BlockByIdQuery = { __typename?: 'Query', blocks: Array<{ __typename?: 'Block', id: string, height: number, hash: string, stateRoot: string, timestamp: any, validator?: string | null, extrinsicsRoot: string, parentHash: string, spec: { __typename?: 'Metadata', specVersion?: number | null }, extrinsics: Array<{ __typename?: 'Extrinsic', id: string, hash: string, call: { __typename?: 'Call', name: string }, block: { __typename?: 'Block', timestamp: any } }>, events: Array<{ __typename?: 'Event', id: string, name: string, phase: string, extrinsic?: { __typename?: 'Extrinsic', id: string } | null }> }> };
