    ...
    <ListItem>
      <div className='flex space-x-4 justify-between'>
        <div className='min-w-0'>
          <p className='text-md font-light text-gray-900 dark:text-white/75 truncate break-all'>{title}</p>
        </div>
        <div className='inline-flex text-base font-normal text-gray-600 dark:text-white items-end break-all'>
          {children}
        </div>
      </div>
    </ListItem>
