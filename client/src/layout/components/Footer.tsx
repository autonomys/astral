      ...
      <div className='container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col'>
        <div className='flex flex-col justify-between'>
          <div className='w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left'>
            <Link to='/' className='flex title-font font-medium items-center mb-4 '>
              <LogoIcon />
            </Link>
          </div>
        ...
        <div className='flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center'>
          <div className='lg:w-1/4 md:w-1/2 w-full px-4'>
            ...
            <nav className='list-none mb-10'>
              <li>
                <a href={EXTERNAL_ROUTES.subspace} className='text-[#ffffffb3] hover:text-gray-800'>
                  Subspace
                </a>
              </li>
              <li>
                <a href={EXTERNAL_ROUTES.forum} className='text-[#ffffffb3] hover:text-gray-800'>
                  Forum
                </a>
              </li>
              <li>
                <a href={EXTERNAL_ROUTES.docs} className='text-[#ffffffb3] hover:text-gray-800'>
                  Docs
                </a>
              </li>
            </nav>
