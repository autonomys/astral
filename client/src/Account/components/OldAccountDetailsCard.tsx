...
// account
import { OldAccountBalanceStats } from 'Account/components'
...
const OldAccountDetailsCard: FC<Props> = ({ account, accountAddress }) => {
        ...
        <List>
          ...
          <ListItem>
            <Accordion title='Balance' value={`${accountTotal}`}>
              <OldAccountBalanceStats account={account} />
            </Accordion>
          </ListItem>
        </List>
      </div>
...
export default OldAccountDetailsCard
