...
const BlockDetailsCard: FC<Props> = ({ block, isDesktop = false }) => {
  return (
    <div className='w-full'>
      <div className='border border-slate-100 bg-white shadow rounded-xl mb-4 py-4 px-3 sm:p-6 w-full dark:bg-gradient-to-r dark:from-[#4141B3] dark:via-[#6B5ACF] dark:to-[#896BD2] dark:border-none'>
