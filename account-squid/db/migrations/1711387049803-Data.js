module.exports = class Data1711387049803 {
    name = 'Data1711387049803'
    ...
    async up(db) {
        ...
        await db.query(`CREATE INDEX "IDX_3e9dfd81b129caa0b9d3b8f4ab" ON "account" ("updated_at_block") `)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_3e9dfd81b129caa0b9d3b8f4ab"`)
