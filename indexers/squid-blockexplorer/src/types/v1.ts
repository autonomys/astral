...
export type FraudProof = FraudProof_InvalidStateTransition | FraudProof_InvalidTransaction | FraudProof_BundleEquivocation | FraudProof_ImproperTransactionSortition | FraudProof_InvalidBlockFees | FraudProof_InvalidExtrinsicsRoot | FraudProof_ValidBundle | FraudProof_InvalidDomainBlockHash | FraudProof_InvalidBundles | FraudProof_InvalidTransfers
...
export interface ConfirmedDomainBlock {
    ...
    parentBlockReceiptHash: Uint8Array
...
export type DomainsHoldIdentifier = DomainsHoldIdentifier_Staking | DomainsHoldIdentifier_DomainInstantiation | DomainsHoldIdentifier_StorageFund
