...
export const reports =  {
     ...
     */
    v0: new StorageType('OffencesSubspace.Reports', 'Optional', [v0.H256], v0.OffenceDetails) as ReportsV0,
}
...
export interface ReportsV0  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: v0.H256, v: (v0.OffenceDetails | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: v0.H256): AsyncIterable<[k: v0.H256, v: (v0.OffenceDetails | undefined)][]>
}
...
export const concurrentReportsIndex =  {
     ...
     */
    v0: new StorageType('OffencesSubspace.ConcurrentReportsIndex', 'Default', [sts.bytes(), sts.bytes()], sts.array(() => v0.H256)) as ConcurrentReportsIndexV0,
}
...
export interface ConcurrentReportsIndexV0  {
    ...
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: [Bytes, Bytes], v: (v0.H256[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: Bytes): AsyncIterable<[k: [Bytes, Bytes], v: (v0.H256[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: Bytes, key2: Bytes): AsyncIterable<[k: [Bytes, Bytes], v: (v0.H256[] | undefined)][]>
}
...
export const reportsByKindIndex =  {
     ...
     */
    v0: new StorageType('OffencesSubspace.ReportsByKindIndex', 'Default', [sts.bytes()], sts.bytes()) as ReportsByKindIndexV0,
}
