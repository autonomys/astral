...
Our Consensus Indexer using [Squid](https://subsquid.io).
It is in use at [Astral - Consensus](https://explorer.autonomys.xyz/gemini-3h/consensus) Autonomys Explorer, Consensus section.
