module.exports = class Data1724203054399 {
    name = 'Data1724203054399'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "extrinsic_module_name" ("id" character varying NOT NULL, "name" text NOT NULL, "created_at" integer NOT NULL, CONSTRAINT "PK_e3d3a5a01f50bf01655cf4f30eb" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_bf23a0cce635d8eba9918d0339" ON "extrinsic_module_name" ("name") `)
        await db.query(`CREATE INDEX "IDX_e0dd20a60a46b0b9268ed2830e" ON "extrinsic_module_name" ("created_at") `)
        ...
        await db.query(`CREATE TABLE "event_module_name" ("id" character varying NOT NULL, "name" text NOT NULL, "created_at" integer NOT NULL, CONSTRAINT "PK_07f4296e4cf56dce19efa3be07c" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_ec4fc7a578894139f5bbdfbb33" ON "event_module_name" ("name") `)
        await db.query(`CREATE INDEX "IDX_21dacdfedad37a0c7547c5164a" ON "event_module_name" ("created_at") `)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_e0dd20a60a46b0b9268ed2830e"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_21dacdfedad37a0c7547c5164a"`)
