module.exports = class Data1724341714619 {
    name = 'Data1724341714619'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "log_kind" ("id" character varying NOT NULL, "kind" text NOT NULL, "count" integer NOT NULL, "created_at" integer NOT NULL, "updated_at" integer NOT NULL, CONSTRAINT "PK_bcc5da35c9fa4e56dda4840b983" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_ce2f3195a2f7faedbab1705f0b" ON "log_kind" ("kind") `)
        await db.query(`CREATE INDEX "IDX_4461ddd62e3d675e860adccbfa" ON "log_kind" ("created_at") `)
        await db.query(`CREATE INDEX "IDX_a1445134448d50ea2af168cc20" ON "log_kind" ("updated_at") `)
        ...
        await db.query(`CREATE TABLE "call" ("id" character varying NOT NULL, "name" text NOT NULL, "success" boolean NOT NULL, "args" text NOT NULL, "block_id" text NOT NULL, "extrinsic_id" text NOT NULL, "error" text NOT NULL, "account_id" text NOT NULL, "parent" text NOT NULL, "pos" integer NOT NULL, "timestamp" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "created_at" integer NOT NULL, CONSTRAINT "PK_2098af0169792a34f9cfdd39c47" PRIMARY KEY ("id"))`)
    ...
    async down(db) {
        ...
        await db.query(`DROP TABLE "log_kind"`)
        await db.query(`DROP INDEX "public"."IDX_ce2f3195a2f7faedbab1705f0b"`)
        await db.query(`DROP INDEX "public"."IDX_4461ddd62e3d675e860adccbfa"`)
        await db.query(`DROP INDEX "public"."IDX_a1445134448d50ea2af168cc20"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_81967fe06abefb07692bcc1b59"`)
