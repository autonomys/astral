module.exports = class Data1724209403174 {
    name = 'Data1724209403174'

    async up(db) {
        await db.query(`CREATE TABLE "module" ("id" character varying NOT NULL, "name" text NOT NULL, "created_at" integer NOT NULL, CONSTRAINT "PK_0e20d657f968b051e674fbe3117" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "extrinsic_name" ("id" character varying NOT NULL, "module_id" text NOT NULL, "name" text NOT NULL, "created_at" integer NOT NULL, CONSTRAINT "PK_1ab24c1987dcd101809f5a8a3e1" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "event_name" ("id" character varying NOT NULL, "module_id" text NOT NULL, "name" text NOT NULL, "created_at" integer NOT NULL, CONSTRAINT "PK_a24cc2e16061e6ac9737931298b" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "transfer" ("id" character varying NOT NULL, "from" text NOT NULL, "to" text NOT NULL, "value" numeric NOT NULL, "timestamp" numeric NOT NULL, "created_at" integer NOT NULL, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "extrinsic" ("id" character varying NOT NULL, "hash" text NOT NULL, "index_in_block" integer NOT NULL, "nonce" numeric NOT NULL, "name" text NOT NULL, "account_id" text NOT NULL, "signature" text NOT NULL, "error" text NOT NULL, "tip" numeric NOT NULL, "fee" numeric NOT NULL, "success" boolean NOT NULL, "block_id" text NOT NULL, "pos" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "args" text NOT NULL, "created_at" integer NOT NULL, CONSTRAINT "PK_80d7db0e4b1e83e30336bc76755" PRIMARY KEY ("id"))`)
