...
export const nextFeeMultiplier =  {
    v0: new StorageType('TransactionPayment.NextFeeMultiplier', 'Default', [], v0.FixedU128) as NextFeeMultiplierV0,
}
...
export const storageVersion =  {
    v0: new StorageType('TransactionPayment.StorageVersion', 'Default', [], v0.Releases) as StorageVersionV0,
}
