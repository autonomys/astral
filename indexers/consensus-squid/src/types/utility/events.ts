...
export const batchCompleted = {
   ...
   */
  v0: new EventType('Utility.BatchCompleted', sts.unit()),
}
...
export const batchCompletedWithErrors = {
   ...
   */
  v0: new EventType('Utility.BatchCompletedWithErrors', sts.unit()),
}
...
export const itemCompleted = {
   ...
   */
  v0: new EventType('Utility.ItemCompleted', sts.unit()),
}
