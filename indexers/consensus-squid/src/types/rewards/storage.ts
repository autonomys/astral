...
export const avgBlockspaceUsage = {
   ...
   */
  v3: new StorageType(
    'Rewards.AvgBlockspaceUsage',
    'Default',
    [],
    sts.number(),
  ) as AvgBlockspaceUsageV3,
}
...
export const remainingIssuance = {
   ...
   */
  v3: new StorageType(
    'Rewards.RemainingIssuance',
    'Default',
    [],
    sts.bigint(),
  ) as RemainingIssuanceV3,
}
...
export const proposerSubsidyPoints = {
   ...
   */
  v3: new StorageType(
    'Rewards.ProposerSubsidyPoints',
    'Default',
    [],
    sts.array(() => v3.RewardPoint),
  ) as ProposerSubsidyPointsV3,
}
