...
export const vestingSchedules =  {
     ...
     */
    v0: new StorageType('Vesting.VestingSchedules', 'Default', [v0.AccountId32], sts.array(() => v0.VestingSchedule)) as VestingSchedulesV0,
}
...
export interface VestingSchedulesV0  {
    ...
    getPairs(block: Block, key: v0.AccountId32): Promise<[k: v0.AccountId32, v: (v0.VestingSchedule[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: v0.AccountId32, v: (v0.VestingSchedule[] | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key: v0.AccountId32): AsyncIterable<[k: v0.AccountId32, v: (v0.VestingSchedule[] | undefined)][]>
}
