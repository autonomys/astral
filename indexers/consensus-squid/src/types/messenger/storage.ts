...
export interface NextChannelIdV0 {
  ...
  getPairsPaged(
    pageSize: number,
    block: Block,
  ): AsyncIterable<[k: v0.ChainId, v: bigint | undefined][]>
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v0.ChainId,
...
export interface ChannelsV0 {
  ...
  getKeysPaged(
    ...
    block: Block,
    key1: v0.ChainId,
  ): AsyncIterable<[v0.ChainId, bigint][]>
  getKeysPaged(
    pageSize: number,
    block: Block,
    key1: v0.ChainId,
  ...
  getPairs(
    block: Block,
    key1: v0.ChainId,
  ): Promise<[k: [v0.ChainId, bigint], v: v0.Channel | undefined][]>
  getPairs(
    block: Block,
    key1: v0.ChainId,
    key2: bigint,
  ...
  getPairsPaged(
    pageSize: number,
    block: Block,
  ): AsyncIterable<[k: [v0.ChainId, bigint], v: v0.Channel | undefined][]>
  getPairsPaged(
    pageSize: number,
    block: Block,
    key1: v0.ChainId,
...
export interface ChannelsV3 {
  ...
  getKeysPaged(
    ...
    block: Block,
    key1: v3.ChainId,
  ): AsyncIterable<[v3.ChainId, bigint][]>
  getKeysPaged(
    pageSize: number,
    block: Block,
    key1: v3.ChainId,
  ...
  getPairs(
    block: Block,
    key1: v3.ChainId,
  ): Promise<[k: [v3.ChainId, bigint], v: v3.Channel | undefined][]>
  getPairs(
    block: Block,
    key1: v3.ChainId,
    key2: bigint,
  ...
  getPairsPaged(
    pageSize: number,
    block: Block,
  ): AsyncIterable<[k: [v3.ChainId, bigint], v: v3.Channel | undefined][]>
  getPairsPaged(
    pageSize: number,
    block: Block,
    key1: v3.ChainId,
...
export const inboxFee = {
  ...
  v0: new StorageType(
    'Messenger.InboxFee',
    'Optional',
    [sts.tuple(() => [v0.ChainId, sts.tuple(() => [sts.bigint(), sts.bigint()])])],
    sts.bigint(),
  ) as InboxFeeV0,
}
...
export interface InboxFeeV0 {
  ...
  getPairs(
    block: Block,
    key: [v0.ChainId, [bigint, bigint]],
  ): Promise<[k: [v0.ChainId, [bigint, bigint]], v: bigint | undefined][]>
  getPairsPaged(
    pageSize: number,
    block: Block,
  ): AsyncIterable<[k: [v0.ChainId, [bigint, bigint]], v: bigint | undefined][]>
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: [v0.ChainId, [bigint, bigint]],
...
export const inboxResponses = {
   ...
   */
  v0: new StorageType(
    'Messenger.InboxResponses',
    'Optional',
    [sts.tuple(() => [v0.ChainId, sts.bigint(), sts.bigint()])],
    v0.Message,
  ) as InboxResponsesV0,
}
...
export interface InboxResponsesV0 {
  ...
  getPairs(
    block: Block,
    key: [v0.ChainId, bigint, bigint],
  ): Promise<[k: [v0.ChainId, bigint, bigint], v: v0.Message | undefined][]>
  getPairsPaged(
    pageSize: number,
    block: Block,
  ): AsyncIterable<[k: [v0.ChainId, bigint, bigint], v: v0.Message | undefined][]>
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: [v0.ChainId, bigint, bigint],
...
export const counterForInboxResponses = {
   ...
   */
  v0: new StorageType(
    'Messenger.CounterForInboxResponses',
    'Default',
    [],
    sts.number(),
  ) as CounterForInboxResponsesV0,
}
...
export const counterForOutbox = {
   ...
   */
  v0: new StorageType(
    'Messenger.CounterForOutbox',
    'Default',
    [],
    sts.number(),
  ) as CounterForOutboxV0,
}
...
export const chainAllowlist = {
   ...
   */
  v3: new StorageType(
    'Messenger.ChainAllowlist',
    'Default',
    [],
    sts.array(() => v3.ChainId),
  ) as ChainAllowlistV3,
}
...
export const domainChainAllowlistUpdate = {
   ...
   */
  v3: new StorageType(
    'Messenger.DomainChainAllowlistUpdate',
    'Optional',
    [v3.DomainId],
    v3.DomainAllowlistUpdates,
  ) as DomainChainAllowlistUpdateV3,
}
...
export interface DomainChainAllowlistUpdateV3 {
  ...
  getPairs(
    block: Block,
    key: v3.DomainId,
  ): Promise<[k: v3.DomainId, v: v3.DomainAllowlistUpdates | undefined][]>
  getPairsPaged(
    pageSize: number,
    block: Block,
  ): AsyncIterable<[k: v3.DomainId, v: v3.DomainAllowlistUpdates | undefined][]>
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v3.DomainId,
...
export const messageWeightTags = {
  ...
  v5: new StorageType(
    ...
    'Optional',
    [],
    v5.MessageWeightTags,
  ) as MessageWeightTagsV5,
}
