...
export const potSlotIterations = {
   ...
   */
  v0: new StorageType(
    'Subspace.PotSlotIterations',
    'Optional',
    [],
    v0.NonZeroU32,
  ) as PotSlotIterationsV0,
}
...
export const shouldAdjustSolutionRange = {
   ...
   */
  v0: new StorageType(
    'Subspace.ShouldAdjustSolutionRange',
    'Default',
    [],
    sts.boolean(),
  ) as ShouldAdjustSolutionRangeV0,
}
...
export const nextSolutionRangeOverride = {
   ...
   */
  v0: new StorageType(
    'Subspace.NextSolutionRangeOverride',
    'Optional',
    [],
    v0.SolutionRangeOverride,
  ) as NextSolutionRangeOverrideV0,
}
...
export interface BlockListV0 {
  ...
  getPairsPaged(
    pageSize: number,
    block: Block,
  ): AsyncIterable<[k: v0.Public, v: null | undefined][]>
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v0.Public,
...
export const segmentCommitment = {
   ...
   */
  v0: new StorageType(
    'Subspace.SegmentCommitment',
    'Optional',
    [v0.SegmentIndex],
    v0.SegmentCommitment,
  ) as SegmentCommitmentV0,
}
...
export interface SegmentCommitmentV0 {
  ...
  getKeysPaged(
    ...
    block: Block,
    key: v0.SegmentIndex,
  ): AsyncIterable<v0.SegmentIndex[]>
  getPairs(block: Block): Promise<[k: v0.SegmentIndex, v: v0.SegmentCommitment | undefined][]>
  getPairs(
    block: Block,
    key: v0.SegmentIndex,
  ): Promise<[k: v0.SegmentIndex, v: v0.SegmentCommitment | undefined][]>
  getPairsPaged(
    pageSize: number,
    block: Block,
  ): AsyncIterable<[k: v0.SegmentIndex, v: v0.SegmentCommitment | undefined][]>
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v0.SegmentIndex,
...
export const counterForSegmentCommitment = {
   ...
   */
  v0: new StorageType(
    'Subspace.CounterForSegmentCommitment',
    'Default',
    [],
    sts.number(),
  ) as CounterForSegmentCommitmentV0,
}
...
export const didProcessSegmentHeaders = {
   ...
   */
  v0: new StorageType(
    'Subspace.DidProcessSegmentHeaders',
    'Default',
    [],
    sts.boolean(),
  ) as DidProcessSegmentHeadersV0,
}
...
export const parentVoteVerificationData = {
   ...
   */
  v0: new StorageType(
    'Subspace.ParentVoteVerificationData',
    'Optional',
    [],
    v0.VoteVerificationData,
  ) as ParentVoteVerificationDataV0,
}
...
export const parentBlockAuthorInfo = {
   ...
   */
  v0: new StorageType(
    'Subspace.ParentBlockAuthorInfo',
    'Optional',
    [],
    sts.tuple(() => [v0.Public, sts.number(), v0.PieceOffset, v0.Scalar, v0.Slot]),
  ) as ParentBlockAuthorInfoV0,
}
...
export const enableRewardsBelowSolutionRange = {
   ...
   */
  v0: new StorageType(
    'Subspace.EnableRewardsBelowSolutionRange',
    'Optional',
    [],
    sts.bigint(),
  ) as EnableRewardsBelowSolutionRangeV0,
}
...
export const currentBlockAuthorInfo = {
   ...
   */
  v0: new StorageType(
    'Subspace.CurrentBlockAuthorInfo',
    'Optional',
    [],
    sts.tuple(() => [v0.Public, sts.number(), v0.PieceOffset, v0.Scalar, v0.Slot, v0.AccountId32]),
  ) as CurrentBlockAuthorInfoV0,
}
...
export interface CurrentBlockAuthorInfoV0 {
  ...
  get(
    block: Block,
  ): Promise<[v0.Public, number, v0.PieceOffset, v0.Scalar, v0.Slot, v0.AccountId32] | undefined>
}
...
export const parentBlockVoters = {
   ...
   */
  v0: new StorageType(
    'Subspace.ParentBlockVoters',
    'Default',
    [],
    sts.array(() =>
      sts.tuple(() => [
        sts.tuple(() => [v0.Public, sts.number(), v0.PieceOffset, v0.Scalar, v0.Slot]),
        sts.tuple(() => [v0.AccountId32, v0.Signature]),
      ]),
    ),
  ) as ParentBlockVotersV0,
}
...
export interface ParentBlockVotersV0 {
  ...
  getDefault(
    block: Block,
  ): [[v0.Public, number, v0.PieceOffset, v0.Scalar, v0.Slot], [v0.AccountId32, v0.Signature]][]
  get(
    block: Block,
  ): Promise<
    | [[v0.Public, number, v0.PieceOffset, v0.Scalar, v0.Slot], [v0.AccountId32, v0.Signature]][]
...
export const potEntropy = {
  ...
  v0: new StorageType(
    ...
    'Default',
    [],
    sts.array(() => sts.tuple(() => [sts.number(), v0.PotEntropyValue])),
  ) as PotEntropyV0,
}
...
export const blockRandomness = {
   ...
   */
  v0: new StorageType(
    'Subspace.BlockRandomness',
    'Optional',
    [],
    v0.Randomness,
  ) as BlockRandomnessV0,
}
...
export const allowAuthoringByAnyone = {
   ...
   */
  v0: new StorageType(
    'Subspace.AllowAuthoringByAnyone',
    'Default',
    [],
    sts.boolean(),
  ) as AllowAuthoringByAnyoneV0,
}
...
export const rootPlotPublicKey = {
   ...
   */
  v0: new StorageType(
    'Subspace.RootPlotPublicKey',
    'Optional',
    [],
    v0.Public,
  ) as RootPlotPublicKeyV0,
}
...
export const blockSlots = {
  ...
  v3: new StorageType(
    ...
    'Default',
    [],
    sts.array(() => sts.tuple(() => [sts.number(), v3.Slot])),
  ) as BlockSlotsV3,
}
