...
export const enableDynamicCostOfStorage = {
   ...
   */
  v0: new StorageType(
    'RuntimeConfigs.EnableDynamicCostOfStorage',
    'Default',
    [],
    sts.boolean(),
  ) as EnableDynamicCostOfStorageV0,
}
...
export const enableBalanceTransfers = {
   ...
   */
  v0: new StorageType(
    'RuntimeConfigs.EnableBalanceTransfers',
    'Default',
    [],
    sts.boolean(),
  ) as EnableBalanceTransfersV0,
}
...
export const enableNonRootCalls = {
   ...
   */
  v0: new StorageType(
    'RuntimeConfigs.EnableNonRootCalls',
    'Default',
    [],
    sts.boolean(),
  ) as EnableNonRootCallsV0,
}
...
export const confirmationDepthK = {
  v0: new StorageType(
    'RuntimeConfigs.ConfirmationDepthK',
    'Default',
    [],
    sts.number(),
  ) as ConfirmationDepthKV0,
}
