...
export const MessageWeightTags: sts.Type<MessageWeightTags> = sts.struct(() => {
    return  {
        outbox: sts.array(() => sts.tuple(() => [sts.tuple(() => [ChainId, sts.tuple(() => [sts.bigint(), sts.bigint()])]), MessageWeightTag])),
        inboxResponses: sts.array(() => sts.tuple(() => [sts.tuple(() => [ChainId, sts.tuple(() => [sts.bigint(), sts.bigint()])]), MessageWeightTag])),
    }
})
