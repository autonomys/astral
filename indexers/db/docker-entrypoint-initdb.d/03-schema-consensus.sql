...
CREATE INDEX "consensus_blocks_height" ON consensus.blocks USING btree (height);
...
CREATE INDEX "consensus_extrinsics_extrinsic_id" ON consensus.extrinsics USING btree (extrinsic_id);
CREATE INDEX "consensus_extrinsics_hash" ON consensus.extrinsics USING btree (hash);
CREATE INDEX "consensus_extrinsics_block_id" ON consensus.extrinsics USING btree (block_id);
...
CREATE INDEX "consensus_events_event_id" ON consensus.events USING btree (event_id);
CREATE INDEX "consensus_events_extrinsic_id" ON consensus.events USING btree (extrinsic_id);
CREATE INDEX "consensus_events_block_id" ON consensus.events USING btree (block_id);
...
CREATE INDEX "consensus_logs_log_id" ON consensus.logs USING btree (log_id);
CREATE INDEX "consensus_logs_block_id" ON consensus.logs USING btree (block_id);
