...
CREATE INDEX leaderboard_account_extrinsic_failed_total_count_histories_block_range_gist ON leaderboard.account_extrinsic_failed_total_count_histories USING gist (_block_range);
CREATE INDEX leaderboard_account_extrinsic_success_total_count_histories_block_range_gist ON leaderboard.account_extrinsic_success_total_count_histories USING gist (_block_range);
CREATE INDEX leaderboard_account_extrinsic_total_count_histories_block_range_gist ON leaderboard.account_extrinsic_total_count_histories USING gist (_block_range);
CREATE INDEX leaderboard_account_remark_count_histories_block_range_gist ON leaderboard.account_remark_count_histories USING gist (_block_range);
CREATE INDEX leaderboard_account_transaction_fee_paid_total_value_histories_block_range_gist ON leaderboard.account_transaction_fee_paid_total_value_histories USING gist (_block_range);
CREATE INDEX leaderboard_account_transfer_receiver_total_count_histories_block_range_gist ON leaderboard.account_transfer_receiver_total_count_histories USING gist (_block_range);
CREATE INDEX leaderboard_account_transfer_receiver_total_value_histories_block_range_gist ON leaderboard.account_transfer_receiver_total_value_histories USING gist (_block_range);
CREATE INDEX leaderboard_account_transfer_sender_total_count_histories_block_range_gist ON leaderboard.account_transfer_sender_total_count_histories USING gist (_block_range);
CREATE INDEX leaderboard_account_transfer_sender_total_value_histories_block_range_gist ON leaderboard.account_transfer_sender_total_value_histories USING gist (_block_range);
CREATE INDEX leaderboard_farmer_block_total_count_histories_block_range_gist ON leaderboard.farmer_block_total_count_histories USING gist (_block_range);
CREATE INDEX leaderboard_farmer_block_total_value_histories_block_range_gist ON leaderboard.farmer_block_total_value_histories USING gist (_block_range);
CREATE INDEX leaderboard_farmer_vote_and_block_total_count_histories_block_range_gist ON leaderboard.farmer_vote_and_block_total_count_histories USING gist (_block_range);
CREATE INDEX leaderboard_farmer_vote_and_block_total_value_histories_block_range_gist ON leaderboard.farmer_vote_and_block_total_value_histories USING gist (_block_range);
CREATE INDEX leaderboard_farmer_vote_total_count_histories_block_range_gist ON leaderboard.farmer_vote_total_count_histories USING gist (_block_range);
CREATE INDEX leaderboard_farmer_vote_total_value_histories_block_range_gist ON leaderboard.farmer_vote_total_value_histories USING gist (_block_range);
CREATE INDEX leaderboard_nominator_deposits_total_count_histories_block_range_gist ON leaderboard.nominator_deposits_total_count_histories USING gist (_block_range);
CREATE INDEX leaderboard_nominator_deposits_total_value_histories_block_range_gist ON leaderboard.nominator_deposits_total_value_histories USING gist (_block_range);
CREATE INDEX leaderboard_nominator_withdrawals_total_count_histories_block_range_gist ON leaderboard.nominator_withdrawals_total_count_histories USING gist (_block_range);
CREATE INDEX leaderboard_nominator_withdrawals_total_value_histories_block_range_gist ON leaderboard.nominator_withdrawals_total_value_histories USING gist (_block_range);
CREATE INDEX leaderboard_operator_bundle_total_count_histories_block_range_gist ON leaderboard.operator_bundle_total_count_histories USING gist (_block_range);
CREATE INDEX leaderboard_operator_deposits_total_count_histories_block_range_gist ON leaderboard.operator_deposits_total_count_histories USING gist (_block_range);
CREATE INDEX leaderboard_operator_deposits_total_value_histories_block_range_gist ON leaderboard.operator_deposits_total_value_histories USING gist (_block_range);
CREATE INDEX leaderboard_operator_total_rewards_collected_histories_block_range_gist ON leaderboard.operator_total_rewards_collected_histories USING gist (_block_range);
CREATE INDEX leaderboard_operator_total_tax_collected_histories_block_range_gist ON leaderboard.operator_total_tax_collected_histories USING gist (_block_range);
CREATE INDEX leaderboard_operator_withdrawals_total_count_histories_block_range_gist ON leaderboard.operator_withdrawals_total_count_histories USING gist (_block_range);
CREATE INDEX leaderboard_operator_withdrawals_total_value_histories_block_range_gist ON leaderboard.operator_withdrawals_total_value_histories USING gist (_block_range);
