-- REMOVED: Transfer triggers that copy data to unified schema
-- These triggers were adding overhead to every transfer INSERT operation
-- The unified transfers.transfers table can be populated via other means if needed
