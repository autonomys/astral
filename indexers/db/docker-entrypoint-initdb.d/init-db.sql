...
CREATE INDEX "leaderboard_farmer_vote_total_value_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
...
CREATE INDEX "leaderboard_operator_deposits_total_count_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
CREATE INDEX "0x3c11ae5e03742fc1" ON leaderboard.farmer_vote_total_count_histories USING btree (id);
CREATE INDEX "leaderboard_farmer_vote_total_count_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
...
CREATE INDEX "leaderboard_operator_withdrawals_total_count_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
...
CREATE INDEX "leaderboard_account_transaction_fee_paid_total_value_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
CREATE INDEX "0x8b7c68617ff4e62b" ON leaderboard.operator_deposits_total_value_histories USING btree (id);
CREATE INDEX "leaderboard_operator_deposits_total_value_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
CREATE INDEX "0x8c12fe09c9fbcd4f" ON leaderboard.farmer_block_total_count_histories USING btree (id);
CREATE INDEX "leaderboard_farmer_block_total_count_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
CREATE INDEX "0x8d7008ea364cf94c" ON leaderboard.account_transfer_sender_total_count_histories USING btree (id);
CREATE INDEX "leaderboard_account_transfer_sender_total_count_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
CREATE INDEX "0x8fa61e629a2dcd38" ON leaderboard.account_transfer_receiver_total_value_histories USING btree (id);
CREATE INDEX "leaderboard_account_transfer_receiver_total_value_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
CREATE INDEX "0x957df7861716b7e5" ON leaderboard.nominator_deposits_total_count_histories USING btree (id);
CREATE INDEX "leaderboard_nominator_deposits_total_count_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
...
CREATE INDEX "leaderboard_account_transfer_receiver_total_count_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
CREATE INDEX "0x9cd9957f6e6b9cf4" ON leaderboard.account_extrinsic_total_count_histories USING btree (id);
CREATE INDEX "leaderboard_account_extrinsic_total_count_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
CREATE INDEX "0x9f3af39f22aac290" ON leaderboard.farmer_vote_and_block_total_count_histories USING btree (id);
CREATE INDEX "leaderboard_farmer_vote_and_block_total_count_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
...
CREATE INDEX "leaderboard_account_remark_count_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
...
CREATE INDEX "leaderboard_nominator_withdrawals_total_count_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
CREATE INDEX "0xc26c8c9093762044" ON leaderboard.nominator_deposits_total_value_histories USING btree (id);
CREATE INDEX "leaderboard_nominator_deposits_total_value_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
...
CREATE INDEX "leaderboard_farmer_vote_and_block_total_value_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
...
CREATE INDEX "leaderboard_operator_bundle_total_count_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
...
CREATE INDEX "leaderboard_operator_total_tax_collected_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
...
CREATE INDEX "leaderboard_account_extrinsic_success_total_count_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
CREATE INDEX "0xde3fa7f872aada9f" ON leaderboard.account_transfer_sender_total_value_histories USING btree (id);
CREATE INDEX "leaderboard_account_transfer_sender_total_value_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
...
CREATE INDEX "leaderboard_account_extrinsic_failed_total_count_histories_account_id" ON leaderboard.farmer_block_total_value_histories USING btree (account_id);
