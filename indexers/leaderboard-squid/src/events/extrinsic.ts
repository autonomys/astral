...
export function processExtrinsicSuccessEvent(
  cache: Cache,
  block: CtxBlock,
  event: CtxEvent
) {
  ...
  const accountExtrinsicTotalCount = getOrCreateAccountExtrinsicTotalCount(
    cache,
    block,
    accountId
  );
  ...
  cache.accountExtrinsicTotalCount.set(
    accountExtrinsicTotalCount.id,
    accountExtrinsicTotalCount
  );

  const accountExtrinsicSuccessTotalCount =
    getOrCreateAccountExtrinsicSuccessTotalCount(cache, block, accountId);
...
export function processExtrinsicFailedEvent(
  ...
  const accountExtrinsicFailedTotalCount =
    getOrCreateAccountExtrinsicFailedTotalCount(cache, block, accountId);
