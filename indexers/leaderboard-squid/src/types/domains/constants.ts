...
export const confirmationDepthK = {
   ...
   */
  v0: new ConstantType('Domains.ConfirmationDepthK', sts.number()),
}
...
export const domainRuntimeUpgradeDelay = {
   ...
   */
  v0: new ConstantType('Domains.DomainRuntimeUpgradeDelay', sts.number()),
}
...
export const blockTreePruningDepth = {
   ...
   */
  v0: new ConstantType('Domains.BlockTreePruningDepth', sts.number()),
}
...
export const maxDomainBlockSize = {
   ...
   */
  v0: new ConstantType('Domains.MaxDomainBlockSize', sts.number()),
}
...
export const maxDomainBlockWeight = {
   ...
   */
  v0: new ConstantType('Domains.MaxDomainBlockWeight', v0.Weight),
}
...
export const maxBundlesPerBlock = {
   ...
   */
  v0: new ConstantType('Domains.MaxBundlesPerBlock', sts.number()),
}
...
export const maxDomainNameLength = {
   ...
   */
  v0: new ConstantType('Domains.MaxDomainNameLength', sts.number()),
}
...
export const domainInstantiationDeposit = {
   ...
   */
  v0: new ConstantType('Domains.DomainInstantiationDeposit', sts.bigint()),
}
...
export const initialDomainTxRange = {
   ...
   */
  v0: new ConstantType('Domains.InitialDomainTxRange', sts.bigint()),
}
...
export const domainTxRangeAdjustmentInterval = {
   ...
   */
  v0: new ConstantType('Domains.DomainTxRangeAdjustmentInterval', sts.bigint()),
}
...
export const minOperatorStake = {
   ...
   */
  v0: new ConstantType('Domains.MinOperatorStake', sts.bigint()),
}
...
export const minNominatorStake = {
   ...
   */
  v0: new ConstantType('Domains.MinNominatorStake', sts.bigint()),
}
...
export const stakeWithdrawalLockingPeriod = {
   ...
   */
  v0: new ConstantType('Domains.StakeWithdrawalLockingPeriod', sts.number()),
}
...
export const stakeEpochDuration = {
   ...
   */
  v0: new ConstantType('Domains.StakeEpochDuration', sts.number()),
}
...
export const treasuryAccount = {
   ...
   *  Treasury account.
   */
  v0: new ConstantType('Domains.TreasuryAccount', v0.AccountId32),
}
...
export const maxPendingStakingOperation = {
   ...
   */
  v0: new ConstantType('Domains.MaxPendingStakingOperation', sts.number()),
}
...
export const maxNominators = {
   ...
   */
  v0: new ConstantType('Domains.MaxNominators', sts.number()),
}
...
export const sudoId = {
   ...
   *  The sudo account id
   */
  v0: new ConstantType('Domains.SudoId', v0.AccountId32),
}
...
export const palletId = {
   ...
   */
  v1: new ConstantType('Domains.PalletId', v1.PalletId),
}
...
export const bundleLongevity = {
   ...
   */
  v3: new ConstantType('Domains.BundleLongevity', sts.number()),
}
