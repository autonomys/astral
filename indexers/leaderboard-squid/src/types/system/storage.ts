...
export interface AccountV0 {
  ...
  getPairs(
    block: Block,
    key: v0.AccountId32,
  ): Promise<[k: v0.AccountId32, v: v0.AccountInfo | undefined][]>
  getPairsPaged(
    pageSize: number,
    block: Block,
  ): AsyncIterable<[k: v0.AccountId32, v: v0.AccountInfo | undefined][]>
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v0.AccountId32,
...
export interface BlockHashV0 {
  ...
  getPairsPaged(
    pageSize: number,
    block: Block,
  ): AsyncIterable<[k: number, v: v0.H256 | undefined][]>
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: number,
...
export interface ExtrinsicDataV0 {
  ...
  getPairsPaged(
    ...
    block: Block,
    key: number,
  ): AsyncIterable<[k: number, v: Bytes | undefined][]>
}
...
export interface EventTopicsV0 {
  ...
  getPairsPaged(
    pageSize: number,
    block: Block,
  ): AsyncIterable<[k: v0.H256, v: [number, number][] | undefined][]>
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v0.H256,
...
export const lastRuntimeUpgrade = {
  ...
  v0: new StorageType(
    ...
    'Optional',
    [],
    v0.LastRuntimeUpgradeInfo,
  ) as LastRuntimeUpgradeV0,
}
...
export const authorizedUpgrade = {
  ...
  v0: new StorageType(
    ...
    'Optional',
    [],
    v0.CodeUpgradeAuthorization,
  ) as AuthorizedUpgradeV0,
}
