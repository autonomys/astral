...
import { BundleSubmissionTask, OperatorDeregistrationTask, OperatorRegistrationTask, OperatorRewardTask, OperatorTaxCollectionTask, OperatorUpdates, StakingProcessingTask } from "../interfaces";
 ...
 */
export const processOperatorTasksBatch = async (tasks: StakingProcessingTask[]): Promise<number> => {
