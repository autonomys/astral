module.exports = class Data1723832727324 {
    name = 'Data1723832727324'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "account" ("id" character varying NOT NULL, "total_deposits" numeric NOT NULL, "total_estimated_withdrawals" numeric NOT NULL, "total_withdrawals" numeric NOT NULL, "total_tax_collected" numeric NOT NULL, "created_at" integer NOT NULL, "updated_at" integer NOT NULL, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "nominator" ("id" character varying NOT NULL, "account_id" text NOT NULL, "domain_id" text NOT NULL, "operator_id" text NOT NULL, "known_shares" numeric NOT NULL, "known_storage_fee_deposit" numeric NOT NULL, "pending_amount" numeric NOT NULL, "pending_storage_fee_deposit" numeric NOT NULL, "pending_effective_domain_epoch" integer NOT NULL, "total_withdrawal_amounts" numeric NOT NULL, "total_storage_fee_refund" numeric NOT NULL, "unlock_at_confirmed_domain_block_number" integer array NOT NULL, "pending_shares" numeric NOT NULL, "pending_storage_fee_refund" numeric NOT NULL, "total_deposits" numeric NOT NULL, "total_estimated_withdrawals" numeric NOT NULL, "total_withdrawals" numeric NOT NULL, "total_deposits_count" integer NOT NULL, "total_withdrawals_count" integer NOT NULL, "accumulated_epoch_shares" numeric NOT NULL, "accumulated_epoch_storage_fee_deposit" numeric NOT NULL, "active_epoch_count" integer NOT NULL, "status" character varying(8) NOT NULL, "pending_action" character varying(27) NOT NULL, "created_at" integer NOT NULL, "updated_at" integer NOT NULL, CONSTRAINT "PK_7489b7a79b066f2660eab25f60b" PRIMARY KEY ("id"))`)
