module.exports = class Data1723823733031 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "account" ("id" character varying NOT NULL, "total_deposits" numeric NOT NULL, "total_tax_collected" numeric NOT NULL, "created_at" integer NOT NULL, "updated_at" integer NOT NULL, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "operator" ("id" character varying NOT NULL, "sort_id" integer NOT NULL, "account_id" text NOT NULL, "domain_id" text NOT NULL, "signing_key" text NOT NULL, "minimum_nominator_stake" numeric NOT NULL, "nomination_tax" integer NOT NULL, "name" text NOT NULL, "description" text NOT NULL, "icon" text NOT NULL, "banner" text NOT NULL, "website" text NOT NULL, "website_verified" boolean NOT NULL, "email" text NOT NULL, "email_verified" boolean NOT NULL, "discord" text NOT NULL, "github" text NOT NULL, "twitter" text NOT NULL, "current_total_stake" numeric NOT NULL, "current_storage_fee_deposit" numeric NOT NULL, "current_epoch_rewards" numeric NOT NULL, "current_total_shares" numeric NOT NULL, "current_share_price" numeric NOT NULL, "raw_status" text NOT NULL, "total_deposits" numeric NOT NULL, "total_tax_collected" numeric NOT NULL, "total_rewards_collected" numeric NOT NULL, "total_transfers_in" numeric NOT NULL, "transfers_in_count" integer NOT NULL, "total_transfers_out" numeric NOT NULL, "transfers_out_count" integer NOT NULL, "total_rejected_transfers_claimed" numeric NOT NULL, "rejected_transfers_claimed_count" integer NOT NULL, "total_transfers_rejected" numeric NOT NULL, "transfers_rejected_count" integer NOT NULL, "total_volume" numeric NOT NULL, "total_consensus_storage_fee" numeric NOT NULL, "total_domain_execution_fee" numeric NOT NULL, "total_burned_balance" numeric NOT NULL, "accumulated_epoch_shares" numeric NOT NULL, "accumulated_epoch_storage_fee_deposit" numeric NOT NULL, "active_epoch_count" integer NOT NULL, "bundle_count" integer NOT NULL, "status" character varying(12) NOT NULL, "pending_action" character varying(27) NOT NULL, "last_bundle_at" integer NOT NULL, "created_at" integer NOT NULL, "updated_at" integer NOT NULL, CONSTRAINT "PK_8b950e1572745d9f69be7748ae8" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "bundle_author" ("id" character varying NOT NULL, "domain_id" text NOT NULL, "account_id" text NOT NULL, "operator_id" text NOT NULL, "bundle_id" text NOT NULL, "domain_block_id" text NOT NULL, CONSTRAINT "PK_54ba310ce65f841f8948c5f230c" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "deposit" ("id" character varying NOT NULL, "account_id" text NOT NULL, "domain_id" text NOT NULL, "operator_id" text NOT NULL, "nominator_id" text NOT NULL, "amount" numeric NOT NULL, "storage_fee_deposit" numeric NOT NULL, "status" character varying(9) NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "extrinsic_hash" text NOT NULL, "epoch_deposited_at" integer NOT NULL, "domain_block_number_deposited_at" integer NOT NULL, "created_at" integer NOT NULL, "staked_at" integer NOT NULL, "updated_at" integer NOT NULL, CONSTRAINT "PK_6654b4be449dadfd9d03a324b61" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "withdrawal" ("id" character varying NOT NULL, "account_id" text NOT NULL, "domain_id" text NOT NULL, "operator_id" text NOT NULL, "nominator_id" text NOT NULL, "shares" numeric NOT NULL, "estimated_amount" numeric NOT NULL, "unlocked_amount" numeric NOT NULL, "unlocked_storage_fee" numeric NOT NULL, "status" character varying(16) NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "withdraw_extrinsic_hash" text NOT NULL, "unlock_extrinsic_hash" text NOT NULL, "epoch_withdrawal_requested_at" integer NOT NULL, "domain_block_number_withdrawal_requested_at" integer NOT NULL, "created_at" integer NOT NULL, "ready_at" integer NOT NULL, "unlocked_at" integer NOT NULL, "updated_at" integer NOT NULL, CONSTRAINT "PK_840e247aaad3fbd4e18129122a2" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "stats" ("id" character varying NOT NULL, "block_number" integer NOT NULL, "total_staked" numeric NOT NULL, "total_tax_collected" numeric NOT NULL, "total_rewards_collected" numeric NOT NULL, "total_deposits" numeric NOT NULL, "total_withdrawals" numeric NOT NULL, "all_time_high_staked" numeric NOT NULL, "domains_count" integer NOT NULL, "operators_count" integer NOT NULL, "active_operators_count" integer NOT NULL, "slashed_operators_count" integer NOT NULL, "nominators_count" integer NOT NULL, "deposits_count" integer NOT NULL, "withdrawals_count" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_c76e93dfef28ba9b6942f578ab1" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "stats_per_domain" ("id" character varying NOT NULL, "domain_id" text NOT NULL, "block_number" integer NOT NULL, "total_staked" numeric NOT NULL, "total_tax_collected" numeric NOT NULL, "total_rewards_collected" numeric NOT NULL, "total_deposits" numeric NOT NULL, "total_withdrawals" numeric NOT NULL, "all_time_high_staked" numeric NOT NULL, "operators_count" integer NOT NULL, "active_operators_count" integer NOT NULL, "slashed_operators_count" integer NOT NULL, "nominators_count" integer NOT NULL, "deposits_count" integer NOT NULL, "withdrawals_count" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_0edbe67267dbe09a2a691517eee" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "stats_per_operator" ("id" character varying NOT NULL, "domain_id" text NOT NULL, "operator_id" text NOT NULL, "block_number" integer NOT NULL, "total_staked" numeric NOT NULL, "total_shares" numeric NOT NULL, "total_tax_collected" numeric NOT NULL, "total_rewards_collected" numeric NOT NULL, "total_deposits" numeric NOT NULL, "total_withdrawals" numeric NOT NULL, "current_share_price" numeric NOT NULL, "all_time_high_staked" numeric NOT NULL, "all_time_high_share_price" numeric NOT NULL, "nominators_count" integer NOT NULL, "deposits_count" integer NOT NULL, "withdrawals_count" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_8cff6fe09e3e5510f0c90e42cf5" PRIMARY KEY ("id"))`)
