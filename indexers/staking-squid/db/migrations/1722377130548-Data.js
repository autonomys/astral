module.exports = class Data1722377130548 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "withdrawal" ("id" character varying NOT NULL, "block_number" integer NOT NULL, "shares" numeric NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "extrinsic_hash" text NOT NULL, "status" character varying(8) NOT NULL, "account_id" character varying, "domain_id" character varying, "operator_id" character varying, "nominator_id" character varying, CONSTRAINT "PK_840e247aaad3fbd4e18129122a2" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "nominator" ("id" character varying NOT NULL, "shares" numeric NOT NULL, "total_deposits" numeric NOT NULL, "deposits_count" integer NOT NULL, "withdrawals_count" integer NOT NULL, "status" character varying(12) NOT NULL, "created_at" integer, "updated_at" integer, "account_id" character varying, "domain_id" character varying, "operator_id" character varying, CONSTRAINT "PK_7489b7a79b066f2660eab25f60b" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "account" ("id" character varying NOT NULL, "total_deposits" numeric NOT NULL, "total_tax_collected" numeric NOT NULL, "operators_count" integer NOT NULL, "nominators_count" integer NOT NULL, "deposits_count" integer NOT NULL, "withdrawals_count" integer NOT NULL, "created_at" integer, "updated_at" integer, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "operator" ("id" character varying NOT NULL, "operator_id" integer NOT NULL, "signing_key" text NOT NULL, "minimum_nominator_stake" numeric NOT NULL, "nomination_tax" integer NOT NULL, "current_total_stake" numeric NOT NULL, "current_storage_fee_deposit" numeric NOT NULL, "current_epoch_rewards" numeric NOT NULL, "current_total_shares" numeric NOT NULL, "total_deposits" numeric NOT NULL, "total_tax_collected" numeric NOT NULL, "raw_status" text, "status" character varying(12) NOT NULL, "nominators_count" integer NOT NULL, "deposits_count" integer NOT NULL, "withdrawals_count" integer NOT NULL, "bundle_count" integer NOT NULL, "last_bundle_at" integer NOT NULL, "created_at" integer, "updated_at" integer, "account_id" character varying, "domain_id" character varying, CONSTRAINT "PK_8b950e1572745d9f69be7748ae8" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "stats_per_domain" ("id" character varying NOT NULL, "block_number" integer NOT NULL, "total_staked" numeric NOT NULL, "total_fees" numeric NOT NULL, "total_deposits" numeric NOT NULL, "total_withdrawals" numeric NOT NULL, "all_time_high_staked" numeric NOT NULL, "operators_count" integer NOT NULL, "active_operators_count" integer NOT NULL, "slashed_operators_count" integer NOT NULL, "nominators_count" integer NOT NULL, "deposits_count" integer NOT NULL, "withdrawals_count" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "domain_id" character varying, CONSTRAINT "PK_0edbe67267dbe09a2a691517eee" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "stats_per_operator" ("id" character varying NOT NULL, "block_number" integer NOT NULL, "total_staked" numeric NOT NULL, "total_fees" numeric NOT NULL, "total_deposits" numeric NOT NULL, "total_withdrawals" numeric NOT NULL, "all_time_high_staked" numeric NOT NULL, "nominators_count" integer NOT NULL, "deposits_count" integer NOT NULL, "withdrawals_count" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "domain_id" character varying, "operator_id" character varying, CONSTRAINT "PK_8cff6fe09e3e5510f0c90e42cf5" PRIMARY KEY ("id"))`)
        ...
        await db.query(`ALTER TABLE "deposit" ADD CONSTRAINT "FK_8dc544cfa89fb544beea0343967" FOREIGN KEY ("domain_id") REFERENCES "domain"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        ...
        await db.query(`ALTER TABLE "withdrawal" ADD CONSTRAINT "FK_12de4d5556aa377a203cb5b1b22" FOREIGN KEY ("domain_id") REFERENCES "domain"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        ...
        await db.query(`ALTER TABLE "nominator" ADD CONSTRAINT "FK_b017cafe03fa79059bd8164c4ea" FOREIGN KEY ("domain_id") REFERENCES "domain"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        ...
        await db.query(`ALTER TABLE "stats_per_operator" ADD CONSTRAINT "FK_4a4bff6af8198a2f145ecf637fa" FOREIGN KEY ("domain_id") REFERENCES "domain"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "stats_per_operator" ADD CONSTRAINT "FK_466db26acddfccae0a5d487d2c3" FOREIGN KEY ("operator_id") REFERENCES "operator"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    }
    ...
    async down(db) {
        ...
        await db.query(`ALTER TABLE "deposit" DROP CONSTRAINT "FK_8dc544cfa89fb544beea0343967"`)
        ...
        await db.query(`ALTER TABLE "withdrawal" DROP CONSTRAINT "FK_12de4d5556aa377a203cb5b1b22"`)
        ...
        await db.query(`ALTER TABLE "nominator" DROP CONSTRAINT "FK_b017cafe03fa79059bd8164c4ea"`)
        ...
        await db.query(`ALTER TABLE "stats_per_operator" DROP CONSTRAINT "FK_4a4bff6af8198a2f145ecf637fa"`)
        await db.query(`ALTER TABLE "stats_per_operator" DROP CONSTRAINT "FK_466db26acddfccae0a5d487d2c3"`)
    }
}
