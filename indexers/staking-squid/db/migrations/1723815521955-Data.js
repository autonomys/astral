module.exports = class Data1723815521955 {
    name = 'Data1723815521955'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "withdrawal" ("id" character varying NOT NULL, "account_id" text NOT NULL, "domain_id" text NOT NULL, "operator_id" text NOT NULL, "nominator_id" text NOT NULL, "shares" numeric NOT NULL, "status" character varying(8) NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "withdraw_extrinsic_hash" text NOT NULL, "unlock_extrinsic_hash" text NOT NULL, "epoch_withdrawal_requested_at" integer NOT NULL, "domain_block_number_withdrawal_requested_at" integer NOT NULL, "created_at" integer NOT NULL, "ready_at" integer NOT NULL, "unlocked_at" integer NOT NULL, "updated_at" integer NOT NULL, CONSTRAINT "PK_840e247aaad3fbd4e18129122a2" PRIMARY KEY ("id"))`)
