module.exports = class Data1724102011801 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "domain_block" ("id" character varying NOT NULL, "domain_id" text NOT NULL, "block_number" integer NOT NULL, "block_hash" text NOT NULL, "extrinsic_root" text NOT NULL, "epoch" integer NOT NULL, "consensus_block_number" integer NOT NULL, "consensus_block_hash" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "created_at" integer NOT NULL, "updated_at" integer NOT NULL, CONSTRAINT "PK_80e382ab071c0035308c3bbe269" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "bundle_author" ("id" character varying NOT NULL, "domain_id" text NOT NULL, "account_id" text NOT NULL, "operator_id" text NOT NULL, "bundle_id" text NOT NULL, "domain_block_id" text NOT NULL, "epoch" integer NOT NULL, CONSTRAINT "PK_54ba310ce65f841f8948c5f230c" PRIMARY KEY ("id"))`)
