...
export const successfulBundles = {
   ...
   */
  v0: new StorageType(
    "Domains.SuccessfulBundles",
    "Default",
    [v0.DomainId],
    sts.array(() => v0.H256)
  ) as SuccessfulBundlesV0,
};
...
export interface SuccessfulBundlesV0 {
  ...
  getKeysPaged(
    ...
    block: Block,
    key: v0.DomainId
  ): AsyncIterable<v0.DomainId[]>;
  getPairs(block: Block): Promise<[k: v0.DomainId, v: v0.H256[] | undefined][]>;
  getPairs(
    block: Block,
    key: v0.DomainId
  ): Promise<[k: v0.DomainId, v: v0.H256[] | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: v0.DomainId, v: v0.H256[] | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v0.DomainId
...
export const successfulFraudProofs = {
   ...
   */
  v0: new StorageType(
    "Domains.SuccessfulFraudProofs",
    "Default",
    [v0.DomainId],
    sts.array(() => v0.H256)
  ) as SuccessfulFraudProofsV0,
};
...
export const runtimeRegistry = {
  v0: new StorageType(
    "Domains.RuntimeRegistry",
    "Optional",
    [sts.number()],
    v0.RuntimeObject
  ) as RuntimeRegistryV0,
  v5: new StorageType(
    "Domains.RuntimeRegistry",
    "Optional",
    [sts.number()],
    v5.RuntimeObject
  ) as RuntimeRegistryV5,
};
...
export interface RuntimeRegistryV0 {
  ...
  getMany(
    block: Block,
    keys: number[]
  ): Promise<(v0.RuntimeObject | undefined)[]>;
  ...
  getPairs(
    block: Block
  ): Promise<[k: number, v: v0.RuntimeObject | undefined][]>;
  getPairs(
    block: Block,
    key: number
  ): Promise<[k: number, v: v0.RuntimeObject | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: number, v: v0.RuntimeObject | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: number
...
export interface RuntimeRegistryV5 {
  ...
  getMany(
    block: Block,
    keys: number[]
  ): Promise<(v5.RuntimeObject | undefined)[]>;
  getKeys(block: Block): Promise<number[]>;
  getKeys(block: Block, key: number): Promise<number[]>;
  getKeysPaged(pageSize: number, block: Block): AsyncIterable<number[]>;
  getKeysPaged(
  ...
  getPairs(
    block: Block
  ): Promise<[k: number, v: v5.RuntimeObject | undefined][]>;
  getPairs(
    block: Block,
    key: number
  ): Promise<[k: number, v: v5.RuntimeObject | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: number, v: v5.RuntimeObject | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: number
...
export const scheduledRuntimeUpgrades = {
  v0: new StorageType(
    "Domains.ScheduledRuntimeUpgrades",
    "Optional",
    [sts.number(), sts.number()],
    v0.ScheduledRuntimeUpgrade
  ) as ScheduledRuntimeUpgradesV0,
};
...
export interface ScheduledRuntimeUpgradesV0 {
  ...
  get(
    ...
    key1: number,
    key2: number
  ): Promise<v0.ScheduledRuntimeUpgrade | undefined>;
  getMany(
    block: Block,
    keys: [number, number][]
  ): Promise<(v0.ScheduledRuntimeUpgrade | undefined)[]>;
  ...
  getPairs(
    ...
    [k: [number, number], v: v0.ScheduledRuntimeUpgrade | undefined][]
  >;
  getPairs(
    block: Block,
    key1: number
...
export const operatorIdOwner = {
  v0: new StorageType(
    "Domains.OperatorIdOwner",
    "Optional",
    [sts.bigint()],
    v0.AccountId32
  ) as OperatorIdOwnerV0,
};
...
export interface OperatorIdOwnerV0 {
  ...
  getMany(
    block: Block,
    keys: bigint[]
  ): Promise<(v0.AccountId32 | undefined)[]>;
  ...
  getPairs(
    block: Block,
    key: bigint
  ): Promise<[k: bigint, v: v0.AccountId32 | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: bigint, v: v0.AccountId32 | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: bigint
...
export const operatorSigningKey = {
   ...
   */
  v0: new StorageType(
    "Domains.OperatorSigningKey",
    "Optional",
    [sts.bytes()],
    sts.bigint()
  ) as OperatorSigningKeyV0,
};
...
export interface OperatorSigningKeyV0 {
  ...
  getPairs(
    block: Block,
    key: Bytes
  ): Promise<[k: Bytes, v: bigint | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: Bytes, v: bigint | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: Bytes
...
export const domainStakingSummary = {
  v0: new StorageType(
    "Domains.DomainStakingSummary",
    "Optional",
    [v0.DomainId],
    v0.StakingSummary
  ) as DomainStakingSummaryV0,
};
...
export interface DomainStakingSummaryV0 {
  ...
  getMany(
    block: Block,
    keys: v0.DomainId[]
  ): Promise<(v0.StakingSummary | undefined)[]>;
  getKeys(block: Block): Promise<v0.DomainId[]>;
  getKeys(block: Block, key: v0.DomainId): Promise<v0.DomainId[]>;
  getKeysPaged(pageSize: number, block: Block): AsyncIterable<v0.DomainId[]>;
  getKeysPaged(
  ...
  getPairs(
    block: Block
  ): Promise<[k: v0.DomainId, v: v0.StakingSummary | undefined][]>;
  getPairs(
    block: Block,
    key: v0.DomainId
  ): Promise<[k: v0.DomainId, v: v0.StakingSummary | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: v0.DomainId, v: v0.StakingSummary | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v0.DomainId
...
export interface OperatorsV0 {
  ...
  getPairs(
    block: Block,
    key: bigint
  ): Promise<[k: bigint, v: v0.Operator | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: bigint, v: v0.Operator | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: bigint
...
export interface OperatorsV1 {
  ...
  getPairs(
    block: Block,
    key: bigint
  ): Promise<[k: bigint, v: v1.Operator | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: bigint, v: v1.Operator | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: bigint
...
export interface OperatorsV3 {
  ...
  getPairs(
    block: Block,
    key: bigint
  ): Promise<[k: bigint, v: v3.Operator | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: bigint, v: v3.Operator | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: bigint
...
export const pendingOperatorSwitches = {
   ...
   */
  v0: new StorageType(
    "Domains.PendingOperatorSwitches",
    "Optional",
    [v0.DomainId],
    sts.array(() => sts.bigint())
  ) as PendingOperatorSwitchesV0,
};
...
export interface PendingOperatorSwitchesV0 {
  ...
  getPairs(
    block: Block,
    key: v0.DomainId
  ): Promise<[k: v0.DomainId, v: bigint[] | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: v0.DomainId, v: bigint[] | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v0.DomainId
...
export const operatorEpochSharePrice = {
   ...
   */
  v0: new StorageType(
    "Domains.OperatorEpochSharePrice",
    "Optional",
    [sts.bigint(), v0.DomainEpoch],
    v0.SharePrice
  ) as OperatorEpochSharePriceV0,
};
...
export interface OperatorEpochSharePriceV0 {
  ...
  get(
    ...
    key1: bigint,
    key2: v0.DomainEpoch
  ): Promise<v0.SharePrice | undefined>;
  getMany(
    block: Block,
    keys: [bigint, v0.DomainEpoch][]
  ): Promise<(v0.SharePrice | undefined)[]>;
  ...
  getKeys(
    ...
    key1: bigint,
    key2: v0.DomainEpoch
  ): Promise<[bigint, v0.DomainEpoch][]>;
  getKeysPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[bigint, v0.DomainEpoch][]>;
  getKeysPaged(
    pageSize: number,
    block: Block,
    key1: bigint
  ...
  getPairs(
    block: Block
  ): Promise<[k: [bigint, v0.DomainEpoch], v: v0.SharePrice | undefined][]>;
  getPairs(
    block: Block,
    key1: bigint
  ): Promise<[k: [bigint, v0.DomainEpoch], v: v0.SharePrice | undefined][]>;
  ...
  getPairsPaged(
    ...
    [k: [bigint, v0.DomainEpoch], v: v0.SharePrice | undefined][]
  >;
  getPairsPaged(
    pageSize: number,
    block: Block,
...
export interface DepositsV0 {
  ...
  getPairs(
    block: Block
  ): Promise<[k: [bigint, v0.AccountId32], v: v0.Deposit | undefined][]>;
  getPairs(
    block: Block,
    key1: bigint
  ): Promise<[k: [bigint, v0.AccountId32], v: v0.Deposit | undefined][]>;
  ...
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: [bigint, v0.AccountId32], v: v0.Deposit | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key1: bigint
...
export interface DepositsV1 {
  ...
  get(
    ...
    key1: bigint,
    key2: v1.AccountId32
  ): Promise<v1.Deposit | undefined>;
  getMany(
    block: Block,
    keys: [bigint, v1.AccountId32][]
  ): Promise<(v1.Deposit | undefined)[]>;
  ...
  getKeys(
    ...
    key1: bigint,
    key2: v1.AccountId32
  ): Promise<[bigint, v1.AccountId32][]>;
  getKeysPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[bigint, v1.AccountId32][]>;
  getKeysPaged(
    pageSize: number,
    block: Block,
    key1: bigint
  ...
  getPairs(
    block: Block
  ): Promise<[k: [bigint, v1.AccountId32], v: v1.Deposit | undefined][]>;
  getPairs(
    block: Block,
    key1: bigint
  ): Promise<[k: [bigint, v1.AccountId32], v: v1.Deposit | undefined][]>;
  ...
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: [bigint, v1.AccountId32], v: v1.Deposit | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key1: bigint
...
export interface WithdrawalsV0 {
  ...
  get(
    ...
    key1: bigint,
    key2: v0.AccountId32
  ): Promise<v0.Withdrawal | undefined>;
  getMany(
    block: Block,
    keys: [bigint, v0.AccountId32][]
  ): Promise<(v0.Withdrawal | undefined)[]>;
  ...
  getPairs(
    block: Block
  ): Promise<[k: [bigint, v0.AccountId32], v: v0.Withdrawal | undefined][]>;
  getPairs(
    block: Block,
    key1: bigint
  ): Promise<[k: [bigint, v0.AccountId32], v: v0.Withdrawal | undefined][]>;
  ...
  getPairsPaged(
    ...
    [k: [bigint, v0.AccountId32], v: v0.Withdrawal | undefined][]
  >;
  getPairsPaged(
    pageSize: number,
    block: Block,
...
export interface WithdrawalsV1 {
  ...
  get(
    ...
    key1: bigint,
    key2: v1.AccountId32
  ): Promise<v1.Withdrawal | undefined>;
  getMany(
    block: Block,
    keys: [bigint, v1.AccountId32][]
  ): Promise<(v1.Withdrawal | undefined)[]>;
  ...
  getPairs(
    block: Block
  ): Promise<[k: [bigint, v1.AccountId32], v: v1.Withdrawal | undefined][]>;
  getPairs(
    block: Block,
    key1: bigint
  ): Promise<[k: [bigint, v1.AccountId32], v: v1.Withdrawal | undefined][]>;
  ...
  getPairsPaged(
    ...
    [k: [bigint, v1.AccountId32], v: v1.Withdrawal | undefined][]
  >;
  getPairsPaged(
    pageSize: number,
    block: Block,
...
export interface NominatorCountV0 {
  ...
  getPairs(
    block: Block,
    key: bigint
  ): Promise<[k: bigint, v: number | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: bigint, v: number | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: bigint
...
export const pendingStakingOperationCount = {
   ...
   */
  v0: new StorageType(
    "Domains.PendingStakingOperationCount",
    "Default",
    [v0.DomainId],
    sts.number()
  ) as PendingStakingOperationCountV0,
};
...
export interface PendingStakingOperationCountV0 {
  ...
  getPairs(
    block: Block,
    key: v0.DomainId
  ): Promise<[k: v0.DomainId, v: number | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: v0.DomainId, v: number | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v0.DomainId
...
export interface DomainRegistryV0 {
  ...
  getMany(
    block: Block,
    keys: v0.DomainId[]
  ): Promise<(v0.DomainObject | undefined)[]>;
  getKeys(block: Block): Promise<v0.DomainId[]>;
  getKeys(block: Block, key: v0.DomainId): Promise<v0.DomainId[]>;
  getKeysPaged(pageSize: number, block: Block): AsyncIterable<v0.DomainId[]>;
  getKeysPaged(
  ...
  getPairs(
    block: Block
  ): Promise<[k: v0.DomainId, v: v0.DomainObject | undefined][]>;
  getPairs(
    block: Block,
    key: v0.DomainId
  ): Promise<[k: v0.DomainId, v: v0.DomainObject | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: v0.DomainId, v: v0.DomainObject | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v0.DomainId
...
export interface DomainRegistryV1 {
  ...
  getMany(
    block: Block,
    keys: v1.DomainId[]
  ): Promise<(v1.DomainObject | undefined)[]>;
  ...
  getKeysPaged(
    ...
    block: Block,
    key: v1.DomainId
  ): AsyncIterable<v1.DomainId[]>;
  getPairs(
    block: Block
  ): Promise<[k: v1.DomainId, v: v1.DomainObject | undefined][]>;
  getPairs(
    block: Block,
    key: v1.DomainId
  ): Promise<[k: v1.DomainId, v: v1.DomainObject | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: v1.DomainId, v: v1.DomainObject | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v1.DomainId
...
export interface DomainRegistryV5 {
  ...
  getMany(
    block: Block,
    keys: v5.DomainId[]
  ): Promise<(v5.DomainObject | undefined)[]>;
  ...
  getKeysPaged(
    ...
    block: Block,
    key: v5.DomainId
  ): AsyncIterable<v5.DomainId[]>;
  getPairs(
    block: Block
  ): Promise<[k: v5.DomainId, v: v5.DomainObject | undefined][]>;
  getPairs(
    block: Block,
    key: v5.DomainId
  ): Promise<[k: v5.DomainId, v: v5.DomainObject | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: v5.DomainId, v: v5.DomainObject | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v5.DomainId
...
export interface BlockTreeV0 {
  ...
  getKeys(
    ...
    key1: v0.DomainId,
    key2: number
  ): Promise<[v0.DomainId, number][]>;
  getKeysPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[v0.DomainId, number][]>;
  getKeysPaged(
    pageSize: number,
    block: Block,
    key1: v0.DomainId
  ...
  getPairs(
    block: Block
  ): Promise<[k: [v0.DomainId, number], v: v0.H256 | undefined][]>;
  getPairs(
    block: Block,
    key1: v0.DomainId
  ): Promise<[k: [v0.DomainId, number], v: v0.H256 | undefined][]>;
  ...
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: [v0.DomainId, number], v: v0.H256 | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key1: v0.DomainId
...
export interface BlockTreeNodesV0 {
  ...
  getMany(
    block: Block,
    keys: v0.H256[]
  ): Promise<(v0.BlockTreeNode | undefined)[]>;
  ...
  getKeysPaged(
    ...
    block: Block,
    key: v0.H256
  ): AsyncIterable<v0.H256[]>;
  getPairs(
    block: Block
  ): Promise<[k: v0.H256, v: v0.BlockTreeNode | undefined][]>;
  getPairs(
    block: Block,
    key: v0.H256
  ): Promise<[k: v0.H256, v: v0.BlockTreeNode | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: v0.H256, v: v0.BlockTreeNode | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v0.H256
...
export interface BlockTreeNodesV1 {
  ...
  getMany(
    block: Block,
    keys: v1.H256[]
  ): Promise<(v1.BlockTreeNode | undefined)[]>;
  ...
  getKeysPaged(
    ...
    block: Block,
    key: v1.H256
  ): AsyncIterable<v1.H256[]>;
  getPairs(
    block: Block
  ): Promise<[k: v1.H256, v: v1.BlockTreeNode | undefined][]>;
  getPairs(
    block: Block,
    key: v1.H256
  ): Promise<[k: v1.H256, v: v1.BlockTreeNode | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: v1.H256, v: v1.BlockTreeNode | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v1.H256
...
export interface BlockTreeNodesV5 {
  ...
  getMany(
    block: Block,
    keys: v5.H256[]
  ): Promise<(v5.BlockTreeNode | undefined)[]>;
  ...
  getKeysPaged(
    ...
    block: Block,
    key: v5.H256
  ): AsyncIterable<v5.H256[]>;
  getPairs(
    block: Block
  ): Promise<[k: v5.H256, v: v5.BlockTreeNode | undefined][]>;
  getPairs(
    block: Block,
    key: v5.H256
  ): Promise<[k: v5.H256, v: v5.BlockTreeNode | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: v5.H256, v: v5.BlockTreeNode | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v5.H256
...
export const headReceiptNumber = {
   ...
   */
  v0: new StorageType(
    "Domains.HeadReceiptNumber",
    "Default",
    [v0.DomainId],
    sts.number()
  ) as HeadReceiptNumberV0,
};
...
export const latestConfirmedDomainBlockNumber = {
   ...
   */
  v0: new StorageType(
    "Domains.LatestConfirmedDomainBlockNumber",
    "Default",
    [v0.DomainId],
    sts.number()
  ) as LatestConfirmedDomainBlockNumberV0,
};
...
export const headReceiptExtended = {
   ...
   */
  v0: new StorageType(
    "Domains.HeadReceiptExtended",
    "Default",
    [v0.DomainId],
    sts.boolean()
  ) as HeadReceiptExtendedV0,
};
...
export interface HeadReceiptExtendedV0 {
  ...
  getPairs(
    block: Block,
    key: v0.DomainId
  ): Promise<[k: v0.DomainId, v: boolean | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: v0.DomainId, v: boolean | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v0.DomainId
...
export const stateRoots = {
  ...
  v0: new StorageType(
    "Domains.StateRoots",
    "Optional",
    [sts.tuple(() => [v0.DomainId, sts.number(), v0.H256])],
    v0.H256
  ) as StateRootsV0,
};
...
export interface StateRootsV0 {
  ...
  get(
    block: Block,
    key: [v0.DomainId, number, v0.H256]
  ): Promise<v0.H256 | undefined>;
  getMany(
    block: Block,
    keys: [v0.DomainId, number, v0.H256][]
  ): Promise<(v0.H256 | undefined)[]>;
  getKeys(block: Block): Promise<[v0.DomainId, number, v0.H256][]>;
  getKeys(
    block: Block,
    key: [v0.DomainId, number, v0.H256]
  ): Promise<[v0.DomainId, number, v0.H256][]>;
  getKeysPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[v0.DomainId, number, v0.H256][]>;
  getKeysPaged(
    pageSize: number,
    block: Block,
    key: [v0.DomainId, number, v0.H256]
  ...
  getPairs(
    block: Block
  ): Promise<[k: [v0.DomainId, number, v0.H256], v: v0.H256 | undefined][]>;
  getPairs(
    block: Block,
    key: [v0.DomainId, number, v0.H256]
  ): Promise<[k: [v0.DomainId, number, v0.H256], v: v0.H256 | undefined][]>;
  getPairsPaged(
    ...
    [k: [v0.DomainId, number, v0.H256], v: v0.H256 | undefined][]
  >;
  getPairsPaged(
    pageSize: number,
    block: Block,
...
export const consensusBlockHash = {
   ...
   */
  v0: new StorageType(
    "Domains.ConsensusBlockHash",
    "Optional",
    [v0.DomainId, sts.number()],
    v0.H256
  ) as ConsensusBlockHashV0,
};
...
export const executionInbox = {
   ...
   */
  v0: new StorageType(
    "Domains.ExecutionInbox",
    "Default",
    [v0.DomainId, sts.number(), sts.number()],
    sts.array(() => v0.BundleDigest)
  ) as ExecutionInboxV0,
  /**
   *  A set of `BundleDigest` from all bundles that successfully submitted to the consensus block,
   *  these bundles will be used to construct the domain block and `ExecutionInbox` is used to:
  ...
  v1: new StorageType(
    "Domains.ExecutionInbox",
    "Default",
    [v1.DomainId, sts.number(), sts.number()],
    sts.array(() => v1.BundleDigest)
  ) as ExecutionInboxV1,
};
...
export interface ExecutionInboxV0 {
  ...
  get(
    ...
    key2: number,
    key3: number
  ): Promise<v0.BundleDigest[] | undefined>;
  getMany(
    block: Block,
    keys: [v0.DomainId, number, number][]
  ): Promise<(v0.BundleDigest[] | undefined)[]>;
  getKeys(block: Block): Promise<[v0.DomainId, number, number][]>;
  getKeys(
    block: Block,
    key1: v0.DomainId
  ): Promise<[v0.DomainId, number, number][]>;
  getKeys(
    block: Block,
    key1: v0.DomainId,
    key2: number
  ...
  getKeysPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[v0.DomainId, number, number][]>;
  getKeysPaged(
    pageSize: number,
    block: Block,
    key1: v0.DomainId
  ...
  getPairs(
    ...
    [k: [v0.DomainId, number, number], v: v0.BundleDigest[] | undefined][]
  >;
  getPairs(
    block: Block,
    key1: v0.DomainId
...
export interface ExecutionInboxV1 {
  ...
  get(
    ...
    key2: number,
    key3: number
  ): Promise<v1.BundleDigest[] | undefined>;
  getMany(
    block: Block,
    keys: [v1.DomainId, number, number][]
  ): Promise<(v1.BundleDigest[] | undefined)[]>;
  getKeys(block: Block): Promise<[v1.DomainId, number, number][]>;
  getKeys(
    block: Block,
    key1: v1.DomainId
  ): Promise<[v1.DomainId, number, number][]>;
  getKeys(
    block: Block,
    key1: v1.DomainId,
    key2: number
  ...
  getKeysPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[v1.DomainId, number, number][]>;
  getKeysPaged(
    pageSize: number,
    block: Block,
    key1: v1.DomainId
  ...
  getPairs(
    ...
    [k: [v1.DomainId, number, number], v: v1.BundleDigest[] | undefined][]
  >;
  getPairs(
    block: Block,
    key1: v1.DomainId
...
export const inboxedBundleAuthor = {
   ...
   */
  v0: new StorageType(
    "Domains.InboxedBundleAuthor",
    "Optional",
    [v0.H256],
    sts.bigint()
  ) as InboxedBundleAuthorV0,
};
...
export interface InboxedBundleAuthorV0 {
  ...
  getPairs(
    block: Block,
    key: v0.H256
  ): Promise<[k: v0.H256, v: bigint | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: v0.H256, v: bigint | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v0.H256
...
export const headDomainNumber = {
   ...
   */
  v0: new StorageType(
    "Domains.HeadDomainNumber",
    "Default",
    [v0.DomainId],
    sts.number()
  ) as HeadDomainNumberV0,
};
...
export const lastEpochStakingDistribution = {
   ...
   */
  v0: new StorageType(
    "Domains.LastEpochStakingDistribution",
    "Optional",
    [v0.DomainId],
    v0.ElectionVerificationParams
  ) as LastEpochStakingDistributionV0,
};
...
export interface LastEpochStakingDistributionV0 {
  ...
  get(
    block: Block,
    key: v0.DomainId
  ): Promise<v0.ElectionVerificationParams | undefined>;
  getMany(
    block: Block,
    keys: v0.DomainId[]
  ): Promise<(v0.ElectionVerificationParams | undefined)[]>;
  ...
  getPairs(
    block: Block
  ): Promise<[k: v0.DomainId, v: v0.ElectionVerificationParams | undefined][]>;
  getPairs(
    block: Block,
    key: v0.DomainId
  ): Promise<[k: v0.DomainId, v: v0.ElectionVerificationParams | undefined][]>;
  getPairsPaged(
    ...
    [k: v0.DomainId, v: v0.ElectionVerificationParams | undefined][]
  >;
  getPairsPaged(
    pageSize: number,
    block: Block,
...
export const domainTxRangeState = {
  v0: new StorageType(
    "Domains.DomainTxRangeState",
    "Optional",
    [v0.DomainId],
    v0.TxRangeState
  ) as DomainTxRangeStateV0,
};
...
export interface DomainTxRangeStateV0 {
  ...
  getMany(
    block: Block,
    keys: v0.DomainId[]
  ): Promise<(v0.TxRangeState | undefined)[]>;
  getKeys(block: Block): Promise<v0.DomainId[]>;
  getKeys(block: Block, key: v0.DomainId): Promise<v0.DomainId[]>;
  getKeysPaged(pageSize: number, block: Block): AsyncIterable<v0.DomainId[]>;
  getKeysPaged(
  ...
  getPairs(
    block: Block
  ): Promise<[k: v0.DomainId, v: v0.TxRangeState | undefined][]>;
  getPairs(
    block: Block,
    key: v0.DomainId
  ): Promise<[k: v0.DomainId, v: v0.TxRangeState | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: v0.DomainId, v: v0.TxRangeState | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v0.DomainId
...
export const latestConfirmedDomainBlock = {
   ...
   */
  v1: new StorageType(
    "Domains.LatestConfirmedDomainBlock",
    "Optional",
    [v1.DomainId],
    v1.ConfirmedDomainBlock
  ) as LatestConfirmedDomainBlockV1,
};
...
export interface LatestConfirmedDomainBlockV1 {
  ...
  get(
    block: Block,
    key: v1.DomainId
  ): Promise<v1.ConfirmedDomainBlock | undefined>;
  getMany(
    block: Block,
    keys: v1.DomainId[]
  ): Promise<(v1.ConfirmedDomainBlock | undefined)[]>;
  ...
  getPairs(
    block: Block
  ): Promise<[k: v1.DomainId, v: v1.ConfirmedDomainBlock | undefined][]>;
  getPairs(
    block: Block,
    key: v1.DomainId
  ): Promise<[k: v1.DomainId, v: v1.ConfirmedDomainBlock | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: v1.DomainId, v: v1.ConfirmedDomainBlock | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: v1.DomainId
...
export const latestSubmittedEr = {
   ...
   */
  v3: new StorageType(
    "Domains.LatestSubmittedER",
    "Default",
    [sts.tuple(() => [v3.DomainId, sts.bigint()])],
    sts.number()
  ) as LatestSubmittedErV3,
};
...
export interface LatestSubmittedErV3 {
  ...
  getMany(
    block: Block,
    keys: [v3.DomainId, bigint][]
  ): Promise<(number | undefined)[]>;
  getKeys(block: Block): Promise<[v3.DomainId, bigint][]>;
  getKeys(
    block: Block,
    key: [v3.DomainId, bigint]
  ): Promise<[v3.DomainId, bigint][]>;
  getKeysPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[v3.DomainId, bigint][]>;
  getKeysPaged(
    pageSize: number,
    block: Block,
    key: [v3.DomainId, bigint]
  ...
  getPairs(
    block: Block
  ): Promise<[k: [v3.DomainId, bigint], v: number | undefined][]>;
  getPairs(
    block: Block,
    key: [v3.DomainId, bigint]
  ): Promise<[k: [v3.DomainId, bigint], v: number | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: [v3.DomainId, bigint], v: number | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: [v3.DomainId, bigint]
...
export const operatorHighestSlot = {
   ...
   */
  v5: new StorageType(
    "Domains.OperatorHighestSlot",
    "Default",
    [sts.bigint()],
    sts.bigint()
  ) as OperatorHighestSlotV5,
};
...
export interface OperatorHighestSlotV5 {
  ...
  getPairs(
    block: Block,
    key: bigint
  ): Promise<[k: bigint, v: bigint | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block
  ): AsyncIterable<[k: bigint, v: bigint | undefined][]>;
  getPairsPaged(
    pageSize: number,
    block: Block,
    key: bigint
...
export const operatorBundleSlot = {
   ...
   */
  v5: new StorageType(
    "Domains.OperatorBundleSlot",
    "Default",
    [sts.bigint()],
    sts.array(() => sts.bigint())
  ) as OperatorBundleSlotV5,
};
...
export const permissionedActionAllowedBy = {
   ...
   */
  v5: new StorageType(
    "Domains.PermissionedActionAllowedBy",
    "Optional",
    [],
    v5.PermissionedActionAllowedBy
  ) as PermissionedActionAllowedByV5,
};
...
export const accumulatedTreasuryFunds = {
   ...
   */
  v5: new StorageType(
    "Domains.AccumulatedTreasuryFunds",
    "Default",
    [],
    sts.bigint()
  ) as AccumulatedTreasuryFundsV5,
};
...
export const domainRuntimeUpgradeRecords = {
   ...
   */
  v5: new StorageType(
    "Domains.DomainRuntimeUpgradeRecords",
    "Default",
    [sts.number()],
    sts.array(() =>
      sts.tuple(() => [sts.number(), v5.DomainRuntimeUpgradeEntry])
    )
  ) as DomainRuntimeUpgradeRecordsV5,
};
...
export interface DomainRuntimeUpgradeRecordsV5 {
  ...
  get(
    block: Block,
    key: number
  ): Promise<[number, v5.DomainRuntimeUpgradeEntry][] | undefined>;
  getMany(
    block: Block,
    keys: number[]
  ): Promise<([number, v5.DomainRuntimeUpgradeEntry][] | undefined)[]>;
  ...
  getPairs(
    ...
    [k: number, v: [number, v5.DomainRuntimeUpgradeEntry][] | undefined][]
  >;
  getPairs(
    block: Block,
    key: number
...
export const domainRuntimeUpgrades = {
   ...
   */
  v5: new StorageType(
    "Domains.DomainRuntimeUpgrades",
    "Default",
    [],
    sts.array(() => sts.number())
  ) as DomainRuntimeUpgradesV5,
};
