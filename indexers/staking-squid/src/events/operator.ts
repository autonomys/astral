import { NominatorPendingAction, NominatorStatus, OperatorStatus, WithdrawalStatus } from '../model'
...
export function processOperatorNominatedEvent(
  ...
  const nominator = getOrCreateNominator(cache, block, extrinsic, operatorIdNum, {
    domainId: domain.id,
...
export function processOperatorRewardedEvent(
  ...
  cache.operatorRewardedEvents.set(operatorRewardedEvent.id, operatorRewardedEvent)
