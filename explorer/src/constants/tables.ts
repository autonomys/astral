...
export const AVAILABLE_COLUMNS: AvailableColumns = {
  ...
  operators: [
    ...
    { name: 'yield30d', label: '30d Yield', isSelected: true, accessorKey: 'yield_30d' },
    { name: 'yield7d', label: '7d Yield', isSelected: false, accessorKey: 'yield_7d' },
    { name: 'yield1d', label: '1d Yield', isSelected: false, accessorKey: 'yield_1d' },
    { name: 'currentSharePrice', label: 'Current Share Price', isSelected: false },
