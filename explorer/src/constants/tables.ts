...
export const AVAILABLE_COLUMNS: AvailableColumns = {
  ...
  operators: [
    ...
    { name: 'yield30d', label: '30d Yield', isSelected: false, accessorKey: 'current_30d_yield' },
    { name: 'yield7d', label: '7d Yield', isSelected: false, accessorKey: 'current_7d_yield' },
    { name: 'yield1d', label: '1d Yield', isSelected: false, accessorKey: 'current_1d_yield' },
    { name: 'apy30d', label: '30d APY', isSelected: true, accessorKey: 'current_30d_apy' },
    { name: 'apy7d', label: '7d APY', isSelected: false, accessorKey: 'current_7d_apy' },
    { name: 'apy1d', label: '1d APY', isSelected: false, accessorKey: 'current_1d_apy' },
    { name: 'currentSharePrice', label: 'Current Share Price', isSelected: false },
