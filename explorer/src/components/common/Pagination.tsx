    ...
    <div className='flex w-full items-center justify-between'>
      ...
      <div className='hidden sm:flex sm:flex-1 sm:items-center sm:justify-end'>
        <ReactPaginate
          ...
          breakLabel={
            <span className='relative mx-1 inline-flex items-center rounded-full bg-white px-4 py-2 text-sm font-medium text-gray-700 dark:bg-[#1E254E] dark:text-white'>
              ...
            </span>
          }
