    ...
    <div className='flex w-full items-center justify-between dark:rounded-full dark:border-2 dark:border-boxDark'>
      <div className='flex w-full flex-col gap-6 sm:hidden'>
        <div className='flex w-full flex-1 justify-between sm:hidden'>
          <button
            ...
            className='relative inline-flex items-center rounded-full border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-none dark:bg-buttonDarkFrom dark:text-white'
          >
            Previous
          </button>
          <button
            ...
            className='relative ml-3 inline-flex items-center rounded-full border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-none dark:bg-buttonDarkFrom dark:text-white'
          >
            Next
          </button>
        </div>
      ...
      <div className='hidden sm:flex sm:w-full sm:flex-col sm:items-center sm:justify-between sm:gap-4 lg:flex-row'>
        ...
        <div className='items-center gap-2 sm:flex sm:flex-1 sm:items-center sm:justify-end'>
          <button
            className='relative mr-[14px] inline-flex cursor-pointer items-center rounded-full bg-white p-2 text-sm font-medium text-primaryAccent hover:bg-gray-50 focus:z-20 disabled:cursor-not-allowed disabled:opacity-50 dark:border-none dark:bg-boxDark dark:text-white'
