...
export const TableNavigation = <T extends object>({
  ...
  <>
    ...
    <div className='dark:border-boxDark flex w-full items-center justify-between dark:rounded-full dark:border-2'>
      <div className='flex w-full flex-col gap-6 sm:hidden'>
        <div className='flex w-full flex-1 justify-between sm:hidden'>
          <button
            onClick={() => table.previousPage()}
            disabled={!table.getCanPreviousPage()}
            className='dark:bg-buttonDarkFrom relative inline-flex items-center rounded-full border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-none dark:text-white'
          >
            Previous
          </button>
          <button
            ...
            className='dark:bg-buttonDarkFrom relative ml-3 inline-flex items-center rounded-full border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-none dark:text-white'
          >
            Next
          </button>
        </div>
      ...
      <div className='hidden sm:flex sm:w-full sm:flex-col sm:items-center sm:justify-between sm:gap-4 lg:flex-row '>
        ...
        <div className='items-center gap-2 sm:flex sm:flex-1 sm:items-center sm:justify-end'>
          <button
            className='dark:bg-boxDark relative mr-[14px] inline-flex cursor-pointer items-center rounded-full bg-white p-2 text-sm font-medium text-primaryAccent hover:bg-gray-50 focus:z-20 dark:border-none dark:text-white'
          ...
          <span className='flex items-center gap-1'>
            ...
            <DebouncedInput
              ...
              className='dark:bg-boxDark w-20 rounded-3xl border-none dark:text-white'
            />
          </span>
          {hidePageSizeOptions === undefined && (
            <select
              className='dark:bg-boxDark rounded-3xl border-none dark:text-white'
