...
export const EvmExplorerBanner: FC = () => {
  return (
    <div className='w-full'>
      <div className='w-full rounded-[20px] bg-[#DDEFF1] p-5 shadow dark:border-none dark:bg-gradient-to-r dark:from-[#4141B3] dark:via-[#6B5ACF] dark:to-[#896BD2]'>
        <div className='flex flex-col gap-4'>
          ...
          <Link href={EXTERNAL_ROUTES.novaExplorer} target='_blank'>
...
export const useEvmExplorerBanner = () => {
  const { selectedChain } = useDomains()

  const novaExplorerBanner = useMemo(
    () => (selectedChain?.isDomain ? <EvmExplorerBanner /> : null),
    [selectedChain],
  )
