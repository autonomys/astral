...
export const HeaderBackground: FC = () => {
  ...
  return (
    <div className='absolute top-36 -z-10 w-full '>
      ...
      >
        <div className='absolute inset-x-[40%] top-[-250px] h-[510px] w-12 rounded-full bg-bluePastel dark:bg-transparent lg:w-[510px]' />
        <div className='absolute right-[20%] top-[-340px] h-[510px] w-12 rounded-full bg-greenPastel dark:bg-transparent lg:w-[510px]' />
        <div className='absolute left-[20%] top-[-340px] h-[510px] w-12 rounded-full bg-bluePale dark:bg-transparent lg:w-[510px]' />
      </div>
      {isListView && (
