  ...
  return (
    <div className='flex flex-col items-center justify-center space-y-8 py-8'>
      ...
      <p className='max-w-md text-center text-gray-600 dark:text-gray-400'>
        We are currently working on implementing our staking interface. In the meantime, you can use
        the Polkadot.js staking interface to manage your staking operations.
      </p>
      <a
      ...
      >
        Access Polkadot.js Staking Interface
      </a>
    </div>
  )
}
