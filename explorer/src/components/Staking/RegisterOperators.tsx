  ...
  return (
    <Card>
      ...
      <div className='mt-6 w-full break-words text-base font-medium text-grayDarker dark:text-white'>
        {tokenSymbol} holders (Gemini 3h testnet network only) can stake their {tokenSymbol} to add
        more security to the protocol and earn Staking Incentives. Learn more about the risks
        involved.
      </div>
      ...
      >
        {({ errors, touched, values, handleSubmit, setFieldValue, resetForm }) => (
          <Form className='my-8 w-full' onSubmit={handleSubmit} data-testid='testOperatorStakeForm'>
                        ...
                        <div className={`p-4 ${isDesktop ? 'col-span-1' : 'col-span-1'}`}>
                          ...
                          <div className='mt-4 flex justify-around'>
                            <button
                              ...
                              onClick={() => handleProofOfOwnershipWithSeed(values, setFieldValue)}
                            >
                              Generate proof
                            </button>
                          </div>
