  ...
  return (
    <Tab title={title}>
      <div className='flex w-full flex-col space-y-4'>
        <div className='flex w-full items-center justify-center gap-2 text-base text-grayDark dark:text-white'>
        ...
        <div className='flex w-full items-center justify-center gap-1 text-sm text-grayDark dark:text-white'>
          From block
        ...
        <div className='flex w-full items-center justify-center'>
          <div className='font-large  w-full text-base text-grayDark dark:text-white'>
            {children}
          </div>
        </div>
      </div>
