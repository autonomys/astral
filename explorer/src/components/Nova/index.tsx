        ...
        <div className='m-6 flow-root text-gray-900 dark:text-white'>
          <div className='mb-12 flex w-full flex-col items-center gap-5 overflow-x-auto'>
            <p className='text-center'>
              Nova represents our state-of-the-art EVM (Ethereum Virtual Machine) domain, seamlessly
              integrated with our robust consensus layer. This powerful combination enables a highly
              scalable and efficient blockchain infrastructure, designed to meet the evolving
              demands of modern decentralized applications and smart contracts. By leveraging the
              flexibility and compatibility of the EVM, Nova provides a familiar environment for
              Ethereum developers while offering enhanced performance and security features.
            </p>
            <p className='text-center'>
              Our Nova EVM domain is built to excel in various aspects of blockchain technology. It
              ...
              or complex smart contract systems, Nova provides the ideal foundation for your
              blockchain projects.
            </p>
            <p className='text-center'>
