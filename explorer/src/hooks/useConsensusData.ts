...
export const useConsensusData = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    setDomain({
      ...
      domainTxRangeAdjustmentInterval: domains.domainTxRangeAdjustmentInterval.toHuman() as string,
      minOperatorStake: BigInt(domains.minOperatorStake.toHuman() as string),
      minNominatorStake: BigInt(domains.minNominatorStake.toHuman() as string),
      stakeWithdrawalLockingPeriod: BigInt(
        domains.stakeWithdrawalLockingPeriod.toHuman() as string,
      ),
      stakeEpochDuration: BigInt(domains.stakeEpochDuration.toHuman() as string),
